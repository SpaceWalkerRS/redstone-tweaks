...
public class Tweaks {
	...
	private static final SettingsCategory TWEAKS = new SettingsCategory(CATEGORY_NAME, new ArrayList<>(), new ArrayList<>());
	
	public static class Global {
		
		private static final String PACK_NAME = "Global";
		private static final SettingsPack GLOBAL = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final UpdateOrderSetting BLOCK_UPDATE_ORDER = new UpdateOrderSetting("blockUpdateOrder", "The order in which the world updates neighbors of a block.", new UpdateOrder(Directionality.NONE, UpdateOrder.NotifierOrder.NORMAL, BlockUpdate.Mode.SINGLE_UPDATE, true).
		...
		public static final BooleanSetting DOUBLE_RETRACTION = new BooleanSetting("doubleRetraction", "A re-implementation of behavior that was present in 1.3-1.8, known as \"Jeb retraction\" or \"instant double retraction\". It creates a very narrow window where unpowered pistons can be moved.", false);
		public static final BooleanSetting INSTANT_BLOCK_EVENTS = new BooleanSetting("instantBlockEvents", "Execute block events at the moment they are scheduled.", false);
		...
		public static final BooleanSetting MOVABLE_BLOCK_ENTITIES = new BooleanSetting("movableBlockEntities", "Allow blocks with block entities to be moved by pistons.", false);
		public static final BooleanSetting MOVABLE_MOVING_BLOCKS = new BooleanSetting("movableMovingBlocks", "Allow moving blocks to be moved by pistons.", false);
		public static final IntegerSetting POWER_MAX = new IntegerSetting("maxPower", "The maximum power output of analogue components like redstone wire, comparators, weighted pressure plates, etc.", 15, 0, Settings.Common.MAX_POWER);
		public static final BooleanSetting RANDOMIZE_BLOCK_EVENTS = new BooleanSetting("randomizeBlockEvents", "Randomize the order in which block events are processed.", false);
		public static final BooleanSetting RANDOMIZE_DELAYS = new BooleanSetting("randomizeDelays", "Randomize the delays of all block and fluid ticks that are scheduled.", false);
		public static final BooleanSetting RANDOMIZE_TICK_PRIORITIES = new BooleanSetting("randomizeTickPriorities", "Randomize the tick priorities of all block and fluid ticks that are scheduled.", false);
	...
	public static class BugFixes {
		...
		private static final SettingsPack BUG_FIXES = new SettingsPack(PACK_NAME, new ArrayList<>());
	...
	public static class ActivatorRail {
		...
		private static final SettingsPack ACTIVATOR_RAIL = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY_RISING_EDGE = new IntegerSetting("delayRisingEdge", Settings.Common.DESC_DELAY_RISING_EDGE, 0, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_FALLING_EDGE = new IntegerSetting("delayFallingEdge", Settings.Common.DESC_DELAY_FALLING_EDGE, 0, 0, Settings.Common.MAX_DELAY);
		public static final BooleanSetting LAZY_RISING_EDGE = new BooleanSetting("lazyRisingEdge", Settings.Common.DESC_LAZY_RISING_EDGE, false);
		public static final BooleanSetting LAZY_FALLING_EDGE = new BooleanSetting("lazyFallingEdge", Settings.Common.DESC_LAZY_FALLING_EDGE, false);
		public static final IntegerSetting POWER_LIMIT = new IntegerSetting("powerLimit", "The maximum distance power can flow through rails.", 9, 1, 1023);
		public static final DirectionToBooleanSetting QC = new DirectionToBooleanSetting("quasiConnectivity", Settings.Common.DESC_QC, new Boolean[] {false, false, false, false, false, false});
		public static final BooleanSetting RANDOMIZE_QC = new BooleanSetting("randomizeQuasiConnectivity", Settings.Common.DESC_RANDOMIZE_QC, false);
		public static final TickPrioritySetting TICK_PRIORITY_RISING_EDGE = new TickPrioritySetting("tickPriorityRisingEdge", Settings.Common.DESC_TICK_PRIORITY_RISING_EDGE, TickPriority.NORMAL);
		public static final TickPrioritySetting TICK_PRIORITY_FALLING_EDGE = new TickPrioritySetting("tickPriorityFallingEdge", Settings.Common.DESC_TICK_PRIORITY_FALLING_EDGE, TickPriority.NORMAL);
	}
	
	public static class Bamboo {
		
		private static final String PACK_NAME = "Bamboo";
		private static final SettingsPack BAMBOO = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", Settings.Common.DESC_DELAY_BREAKING, 1, 0, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	
	public static class Barrier {
		
		private static final String PACK_NAME = "Barrier";
		private static final SettingsPack BARRIER = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final BooleanSetting IS_MOVABLE = new BooleanSetting("isMovable", "When enabled, barriers can be moved by pistons.", false);
	}
	
	public static class BubbleColumn {
		
		private static final String PACK_NAME = "Bubble Column";
		private static final SettingsPack BUBBLE_COLUMN = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", "Delay before a bubble column is created.", 5, 0, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class Cactus {
		...
		private static final SettingsPack CACTUS = new SettingsPack(PACK_NAME, new ArrayList<>());
	...
	public static class ChorusPlant {
		...
		private static final SettingsPack CHORUS_PLANT = new SettingsPack(PACK_NAME, new ArrayList<>());
	...
	public static class CommandBlock {
		...
		private static final SettingsPack COMMAND_BLOCK = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", Settings.Common.DESC_DELAY_ACTIVATING, 1, 1, Settings.Common.MAX_DELAY);
		public static final DirectionToBooleanSetting QC = new DirectionToBooleanSetting("quasiConnectivity", Settings.Common.DESC_QC, new Boolean[] {false, false, false, false, false, false});
		public static final BooleanSetting RANDOMIZE_QC = new BooleanSetting("randomizeQuasiConnectivity", Settings.Common.DESC_RANDOMIZE_QC, false);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class Comparator {
		...
		private static final SettingsPack COMPARATOR = new SettingsPack(PACK_NAME, new ArrayList<>());
		...
		public static final UpdateOrderSetting BLOCK_UPDATE_ORDER = new UpdateOrderSetting("blockUpdateOrder", "The order in which the comparator updates its neighbors when its power output changes.", new UpdateOrder(Directionality.HORIZONTAL, UpdateOrder.NotifierOrder.NORMAL).
		...
		public static final IntegerSetting DELAY = new IntegerSetting("delay", "Delay in ticks before changing power output.", 2, 0, Settings.Common.MAX_DELAY);
		...
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
		public static final TickPrioritySetting TICK_PRIORITY_FACING_DIODE = new TickPrioritySetting("tickPriorityFacingDiode", Settings.Common.DESC_TICK_PRIORITY_FACING_DIODE, TickPriority.HIGH);
	}
	
	public static class Composter {
		
		private static final String PACK_NAME = "Composter";
		private static final SettingsPack COMPOSTER = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", "The delay in ticks before transitioning from level 7 to level 8.", 20, 0, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class Coral {
		...
		private static final SettingsPack CORAL = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY_MIN = new IntegerSetting("delayMin", "Minimum delay in ticks.", 60, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_MAX = new IntegerSetting("delayMax", "Maximum delay in ticks.", 100, 0, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class CoralBlock {
		...
		private static final SettingsPack CORAL_BLOCK = new SettingsPack(PACK_NAME, new ArrayList<>());
	...
	public static class DetectorRail {
		...
		private static final SettingsPack DETECTOR_RAIL = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", "Delay in ticks before attempting to depower.", 20, 1, Settings.Common.MAX_DELAY);
		public static final IntegerSetting POWER_WEAK = new IntegerSetting("weakPower", Settings.Common.DESC_POWER_WEAK, 15, 0, Settings.Common.MAX_POWER);
		public static final IntegerSetting POWER_STRONG = new IntegerSetting("strongPower", Settings.Common.DESC_POWER_STRONG, 15, 0, Settings.Common.MAX_POWER);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class Dispenser {
		...
		private static final SettingsPack DISPENSER = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", Settings.Common.DESC_DELAY_ACTIVATING, 4, 0, Settings.Common.MAX_DELAY);
		public static final BooleanSetting LAZY = new BooleanSetting("lazy", Settings.Common.DESC_LAZY, true);
		public static final DirectionToBooleanSetting QC = new DirectionToBooleanSetting("quasiConnectivity", Settings.Common.DESC_QC, new Boolean[] {false, true, false, false, false, false});
		public static final BooleanSetting RANDOMIZE_QC = new BooleanSetting("randomizeQuasiConnectivity", Settings.Common.DESC_RANDOMIZE_QC, false);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class DragonEgg {
		...
		private static final SettingsPack DRAGON_EGG = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", "Delay in ticks before attempting to fall.", 5, 0, Settings.Common.MAX_DELAY);
	}
	
	public static class Dropper {
		
		private static final String PACK_NAME = "Dropper";
		private static final SettingsPack DROPPER = new SettingsPack(PACK_NAME, new ArrayList<>());
	...
	public static class Farmland {
		...
		private static final SettingsPack FARMLAND = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", "Delay in ticks before turning into dirt.", 1, 0, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class Fire {
		...
		private static final SettingsPack FIRE = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY_MIN = new IntegerSetting("delayMin", "Minimum delay in ticks.", 10, 1, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_MAX = new IntegerSetting("delayMax", "Maximum delay in ticks.", 30, 1, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class FrostedIce {
		...
		private static final SettingsPack FROSTED_ICE = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY_MIN = new IntegerSetting("delayMin", "Minimum delay in ticks.", 20, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_MAX = new IntegerSetting("delayMax", "Maximum delay in ticks.", 40, 0, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class GrassPath {
		...
		private static final SettingsPack GRASS_PATH = new SettingsPack(PACK_NAME, new ArrayList<>());
	...
	public static class GravityBlock {
		...
		private static final SettingsPack GRAVITY_BLOCK = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", "Delay before attempting to fall.", 2, 0, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class HeavyWeightedPressurePlate {
		...
		private static final SettingsPack HEAVY_WEIGHTED_PRESSURE_PLATE = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final UpdateOrderSetting BLOCK_UPDATE_ORDER = new UpdateOrderSetting("blockUpdateOrder", "The order in which neighbors are update when the pressure plate powers or depowers.", new UpdateOrder(Directionality.NONE, UpdateOrder.NotifierOrder.NORMAL).
		...
		public static final IntegerSetting DELAY_RISING_EDGE = new IntegerSetting("delayRisingEdge", Settings.Common.DESC_DELAY_RISING_EDGE, 0, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_FALLING_EDGE = new IntegerSetting("delayFallingEdge", Settings.Common.DESC_DELAY_FALLING_EDGE, 10, 0, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY_RISING_EDGE = new TickPrioritySetting("tickPriorityRisingEdge", Settings.Common.DESC_TICK_PRIORITY_RISING_EDGE, TickPriority.NORMAL);
		public static final TickPrioritySetting TICK_PRIORITY_FALLING_EDGE = new TickPrioritySetting("tickPriorityFallingEdge", Settings.Common.DESC_TICK_PRIORITY_FALLING_EDGE, TickPriority.NORMAL);
		public static final IntegerSetting WEIGHT = new IntegerSetting("weight", "The number of entities needed for the pressure plate to emit maximum power.", 150, 1, 1023);
	}
	
	public static class Hopper {
		
		private static final String PACK_NAME = "Hopper";
		private static final SettingsPack HOPPER = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting COOLDOWN_DEFAULT = new IntegerSetting("cooldownDefault", "The default cooldown after transfering or receiving an item.", 8, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting COOLDOWN_PRIORITY = new IntegerSetting("cooldownPriority", "The cooldown if an item is received from a hopper that ticked at the same time or earlier.", 7, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_RISING_EDGE = new IntegerSetting("delayRisingEdge", "Delay in ticks before being locked.", 0, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_FALLING_EDGE = new IntegerSetting("delayFallingEdge", "Delay in ticks before being unlocked", 0, 0, Settings.Common.MAX_DELAY);
		public static final BooleanSetting LAZY_RISING_EDGE = new BooleanSetting("lazyRisingEdge", Settings.Common.DESC_LAZY_RISING_EDGE, false);
		public static final BooleanSetting LAZY_FALLING_EDGE = new BooleanSetting("lazyFallingEdge", Settings.Common.DESC_LAZY_FALLING_EDGE, false);
		public static final DirectionToBooleanSetting QC = new DirectionToBooleanSetting("quasiConnectivity", Settings.Common.DESC_QC, new Boolean[] {false, false, false, false, false, false});
		public static final BooleanSetting RANDOMIZE_QC = new BooleanSetting("randomizeQuasiConnectivity", Settings.Common.DESC_RANDOMIZE_QC, false);
	...
	public static class Lava {
		...
		private static final SettingsPack LAVA = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY_DEFAULT = new IntegerSetting("delayDefault", "Delay in ticks in non-nether dimensions.", 30, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_NETHER = new IntegerSetting("delayNether", "Delay in ticks in the nether dimension.", 10, 0, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class Leaves {
		...
		private static final SettingsPack LEAVES = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", "Delay in ticks before a leaf block updates its distance to the nearest log.", 1, 0, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class Lectern {
		...
		private static final SettingsPack LECTERN = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY_RISING_EDGE = new IntegerSetting("delayRisingEdge", Settings.Common.DESC_DELAY_RISING_EDGE, 0, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_FALLING_EDGE = new IntegerSetting("delayFallingEdge", Settings.Common.DESC_DELAY_FALLING_EDGE, 2, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting POWER_WEAK = new IntegerSetting("weakPower", Settings.Common.DESC_POWER_WEAK, 15, 0, Settings.Common.MAX_POWER);
		public static final IntegerSetting POWER_STRONG = new IntegerSetting("strongPower", Settings.Common.DESC_POWER_STRONG, 15, 0, Settings.Common.MAX_POWER);
		public static final TickPrioritySetting TICK_PRIORITY_RISING_EDGE = new TickPrioritySetting("tickPriorityRisingEdge", Settings.Common.DESC_TICK_PRIORITY_RISING_EDGE, TickPriority.NORMAL);
		public static final TickPrioritySetting TICK_PRIORITY_FALLING_EDGE = new TickPrioritySetting("tickPriorityFallingEdge", Settings.Common.DESC_TICK_PRIORITY_FALLING_EDGE, TickPriority.NORMAL);
	...
	public static class Lever {
		...
		private static final SettingsPack LEVER = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final UpdateOrderSetting BLOCK_UPDATE_ORDER = new UpdateOrderSetting("blockUpdateOrder", "The order in which neighbors are updated when the lever is toggled.", new UpdateOrder(Directionality.ALL, UpdateOrder.NotifierOrder.NORMAL).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.SELF, RelativePos.WEST).
	...
	public static class LightWeightedPressurePlate {
		...
		private static final SettingsPack LIGHT_WEIGHTED_PRESSURE_PLATE = new SettingsPack(PACK_NAME, new ArrayList<>());
		...
		public static final TickPrioritySetting TICK_PRIORITY_RISING_EDGE = new TickPrioritySetting("tickPriorityRisingEdge", Settings.Common.DESC_TICK_PRIORITY_RISING_EDGE, TickPriority.NORMAL);
		public static final TickPrioritySetting TICK_PRIORITY_FALLING_EDGE = new TickPrioritySetting("tickPriorityFallingEdge", Settings.Common.DESC_TICK_PRIORITY_FALLING_EDGE, TickPriority.NORMAL);
		public static final IntegerSetting WEIGHT = new IntegerSetting("weight", "The number of entities needed for the pressure plate to emit maximum power.", 15, 1, 1023);
	}
	
	public static class MagentaGlazedTerracotta {
		
		private static final String PACK_NAME = "Magenta Glazed Terracotta";
		private static final SettingsPack MAGENTA_GLAZED_TERRACOTTA = new SettingsPack(PACK_NAME, new ArrayList<>());
	...
	public static class MagmaBlock {
		...
		private static final SettingsPack MAGMA_BLOCK = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", "Delay in ticks before a magma block updates water above it to create a bubble column.", 20, 0, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class NormalPiston {
		...
		private static final SettingsPack NORMAL_PISTON = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final BooleanSetting CONNECTS_TO_WIRE = new BooleanSetting("connectsToWire", "When enabled, normal pistons connect to redstone wire.", false);
		public static final IntegerSetting DELAY_RISING_EDGE = new IntegerSetting("delayRisingEdge", "Delay in ticks before extending.", 0, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_FALLING_EDGE = new IntegerSetting("delayFallingEdge", "Delay in ticks before retracting", 0, 0, Settings.Common.MAX_DELAY);
		public static final BooleanSetting IGNORE_UPDATES_WHILE_EXTENDING = new BooleanSetting("ignoreUpdatesWhileExtending", "Ignore any neighbor updates received during the extension.", false);
		public static final BooleanSetting IGNORE_UPDATES_WHILE_RETRACTING = new BooleanSetting("ignoreUpdatesWhileRetracting", "Ignore any neighbor updates received during the retraction.", true);
		public static final BooleanSetting LAZY_RISING_EDGE = new BooleanSetting("lazyRisingEdge", Settings.Common.DESC_LAZY_RISING_EDGE, false);
		public static final BooleanSetting LAZY_FALLING_EDGE = new BooleanSetting("lazyFallingEdge", Settings.Common.DESC_LAZY_FALLING_EDGE, false);
		public static final BooleanSetting MOVABLE_WHEN_EXTENDED = new BooleanSetting("movableWhenExtended", "Allow extended pistons to be moved.", false);
		public static final IntegerSetting PUSH_LIMIT = new IntegerSetting("pushLimit", "The maximum number of blocks a piston can move.", 12, 0, 2048);
		public static final DirectionToBooleanSetting QC = new DirectionToBooleanSetting("quasiConnectivity", Settings.Common.DESC_QC, new Boolean[] {false, true, false, false, false, false});
		public static final BooleanSetting RANDOMIZE_QC = new BooleanSetting("randomizeQuasiConnectivity", Settings.Common.DESC_RANDOMIZE_QC, false);
		public static final IntegerSetting SPEED_RISING_EDGE = new IntegerSetting("speedRisingEdge", "The duration of the extension in ticks.", 2, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting SPEED_FALLING_EDGE = new IntegerSetting("speedFallingEdge", "The duration of the retraction in ticks.", 2, 0, Settings.Common.MAX_DELAY);
		public static final BooleanSetting SUPPORTS_BRITTLE_BLOCKS = new BooleanSetting("supportsBrittleBlocks", "Allow brittle blocks, like torches, pressure plates and doors, to be placed on any face, without breaking when the piston extends or retracts.", false);
		...
		public static final TickPrioritySetting TICK_PRIORITY_RISING_EDGE = new TickPrioritySetting("tickPriorityRisingEdge", Settings.Common.DESC_TICK_PRIORITY_RISING_EDGE, TickPriority.NORMAL);
		public static final TickPrioritySetting TICK_PRIORITY_FALLING_EDGE = new TickPrioritySetting("tickPriorityFallingEdge", Settings.Common.DESC_TICK_PRIORITY_FALLING_EDGE, TickPriority.NORMAL);
		public static final BooleanSetting UPDATE_SELF_WHILE_POWERED = new BooleanSetting("updateSelfWhilePowered", "If the piston is powered but cannot extend, it will update itself each tick until it can extend. This is achieved using scheduled ticks.", false);
	}
	
	public static class NoteBlock {
		
		private static final String PACK_NAME = "Note Block";
		private static final SettingsPack NOTE_BLOCK = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", "Delay in ticks before playing a note.", 0, 0, Settings.Common.MAX_DELAY);
		public static final BooleanSetting LAZY = new BooleanSetting("lazy", Settings.Common.DESC_LAZY, false);
		public static final DirectionToBooleanSetting QC = new DirectionToBooleanSetting("quasiConnectivity", Settings.Common.DESC_QC, new Boolean[] {false, false, false, false, false, false});
		public static final BooleanSetting RANDOMIZE_QC = new BooleanSetting("randomizeQuasiConnectivity", Settings.Common.DESC_RANDOMIZE_QC, false);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class Observer {
		...
		private static final SettingsPack OBSERVER = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final UpdateOrderSetting BLOCK_UPDATE_ORDER = new UpdateOrderSetting("blockUpdateOrder", "The order in which neighbors are updated when an observer powers or depowers.", new UpdateOrder(Directionality.ALL, UpdateOrder.NotifierOrder.NORMAL).
				add(BlockUpdate.Mode.SINGLE_UPDATE, RelativePos.SELF, RelativePos.FRONT).
				add(BlockUpdate.Mode.NEIGHBORS_EXCEPT, RelativePos.FRONT, RelativePos.BACK));
		public static final IntegerSetting DELAY_RISING_EDGE = new IntegerSetting("delayRisingEdge", Settings.Common.DESC_DELAY_RISING_EDGE, 2, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_FALLING_EDGE = new IntegerSetting("delayFallingEdge", Settings.Common.DESC_DELAY_FALLING_EDGE, 2, 0, Settings.Common.MAX_DELAY);
		public static final BooleanSetting DISABLE = new BooleanSetting("disable", "Disable observers.", false);
		public static final IntegerSetting POWER_WEAK = new IntegerSetting("weakPower", Settings.Common.DESC_POWER_WEAK, 15, 0, Settings.Common.MAX_POWER);
		public static final IntegerSetting POWER_STRONG = new IntegerSetting("strongPower", Settings.Common.DESC_POWER_STRONG, 15, 0, Settings.Common.MAX_POWER);
		public static final TickPrioritySetting TICK_PRIORITY_RISING_EDGE = new TickPrioritySetting("tickPriorityRisingEdge", Settings.Common.DESC_TICK_PRIORITY_RISING_EDGE, TickPriority.NORMAL);
		public static final TickPrioritySetting TICK_PRIORITY_FALLING_EDGE = new TickPrioritySetting("tickPriorityFallingEdge", Settings.Common.DESC_TICK_PRIORITY_FALLING_EDGE, TickPriority.NORMAL);
	...
	public static class PoweredRail {
		...
		private static final SettingsPack POWERED_RAIL = new SettingsPack(PACK_NAME, new ArrayList<>());
	...
	public static class RedstoneBlock {
		...
		private static final SettingsPack REDSTONE_BLOCK = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final UpdateOrderSetting BLOCK_UPDATE_ORDER = new UpdateOrderSetting("blockUpdateOrder", "The order in which indirect neighbors of the block are updated if redstone blocks emit a strong power greater than 0.", new UpdateOrder(Directionality.NONE, UpdateOrder.NotifierOrder.NORMAL).
		...
		public static final IntegerSetting POWER_WEAK = new IntegerSetting("weakPower", Settings.Common.DESC_POWER_WEAK, 15, 0, Settings.Common.MAX_POWER);
		public static final IntegerSetting POWER_STRONG = new IntegerSetting("strongPower", Settings.Common.DESC_POWER_STRONG, 0, 0, Settings.Common.MAX_POWER);
	}
	
	public static class RedstoneLamp {
		
		private static final String PACK_NAME = "Redstone Lamp";
		private static final SettingsPack REDSTONE_LAMP = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY_RISING_EDGE = new IntegerSetting("delayRisingEdge", Settings.Common.DESC_DELAY_RISING_EDGE, 0, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_FALLING_EDGE = new IntegerSetting("delayFallingEdge", Settings.Common.DESC_DELAY_FALLING_EDGE, 4, 0, Settings.Common.MAX_DELAY);
		public static final BooleanSetting LAZY_RISING_EDGE = new BooleanSetting("lazyRisingEdge", Settings.Common.DESC_LAZY_RISING_EDGE, false);
		public static final BooleanSetting LAZY_FALLING_EDGE = new BooleanSetting("lazyFallingEdge", Settings.Common.DESC_LAZY_FALLING_EDGE, false);
		public static final DirectionToBooleanSetting QC = new DirectionToBooleanSetting("quasiConnectivity", Settings.Common.DESC_QC, new Boolean[] {false, false, false, false, false, false});
		public static final BooleanSetting RANDOMIZE_QC = new BooleanSetting("randomizeQuasiConnectivity", Settings.Common.DESC_RANDOMIZE_QC, false);
	...
	public static class RedstoneOre {
		...
		private static final SettingsPack REDSTONE_ORE = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final UpdateOrderSetting BLOCK_UPDATE_ORDER = new UpdateOrderSetting("blockUpdateOrder", "The order in which indirect neighbors of the block are updated if redstone ore emits a strong power greater than 0.", new UpdateOrder(Directionality.NONE, UpdateOrder.NotifierOrder.NORMAL).
				add(BlockUpdate.Mode.NEIGHBORS_EXCEPT, RelativePos.DOWN, RelativePos.UP).
				add(BlockUpdate.Mode.NEIGHBORS_EXCEPT, RelativePos.UP, RelativePos.DOWN).
				add(BlockUpdate.Mode.NEIGHBORS_EXCEPT, RelativePos.NORTH, RelativePos.SOUTH).
				add(BlockUpdate.Mode.NEIGHBORS_EXCEPT, RelativePos.SOUTH, RelativePos.NORTH).
				add(BlockUpdate.Mode.NEIGHBORS_EXCEPT, RelativePos.WEST, RelativePos.EAST).
				add(BlockUpdate.Mode.NEIGHBORS_EXCEPT, RelativePos.EAST, RelativePos.WEST));
		public static final BooleanSetting CONNECTS_TO_WIRE = new BooleanSetting("connectsToWire", "When enabled, redstone ore connects to redstone wire.", false);
		public static final IntegerSetting DELAY = new IntegerSetting("delay", Settings.Common.DESC_DELAY_ACTIVATING, 0, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting POWER_WEAK = new IntegerSetting("weakPower", Settings.Common.DESC_POWER_WEAK, 0, 0, Settings.Common.MAX_POWER);
		public static final IntegerSetting POWER_STRONG = new IntegerSetting("strongPower", Settings.Common.DESC_POWER_STRONG, 0, 0, Settings.Common.MAX_POWER);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class RedstoneTorch {
		...
		private static final SettingsPack REDSTONE_TORCH = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final UpdateOrderSetting BLOCK_UPDATE_ORDER = new UpdateOrderSetting("blockUpdateOrder", "The order in which neighbors are updated when a redstone torch powers on or off.", new UpdateOrder(Directionality.NONE, UpdateOrder.NotifierOrder.NORMAL).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.DOWN, RelativePos.WEST).
		...
		public static final IntegerSetting BURNOUT_COUNT = new IntegerSetting("burnoutCount", "The number of times a redstone torch must depower to burn out.", 8, 0, 2048);
		public static final IntegerSetting BURNOUT_TIMER = new IntegerSetting("burnoutTimer", "The time in ticks during which a redstone torch must depower a set number of times to burn out.", 60, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_BURNOUT = new IntegerSetting("delayBurnout", "The amount of time for which a redstone torch will be burned out.", 160, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_RISING_EDGE = new IntegerSetting("delayRisingEdge", Settings.Common.DESC_DELAY_RISING_EDGE, 2, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_FALLING_EDGE = new IntegerSetting("delayFallingEdge", Settings.Common.DESC_DELAY_FALLING_EDGE, 2, 0, Settings.Common.MAX_DELAY);
		public static final BooleanSetting LAZY_RISING_EDGE = new BooleanSetting("lazyRisingEdge", Settings.Common.DESC_LAZY_RISING_EDGE, false);
		public static final BooleanSetting LAZY_FALLING_EDGE = new BooleanSetting("lazyFallingEdge", Settings.Common.DESC_LAZY_FALLING_EDGE, false);
		public static final IntegerSetting POWER_WEAK = new IntegerSetting("weakPower", Settings.Common.DESC_POWER_WEAK, 15, 0, Settings.Common.MAX_POWER);
		public static final IntegerSetting POWER_STRONG = new IntegerSetting("strongPower", Settings.Common.DESC_POWER_STRONG, 15, 0, Settings.Common.MAX_POWER);
		public static final BooleanSetting SOFT_INVERSION = new BooleanSetting("softInversion", "An implementation of behavior present in the Bedrock Edition known as \"soft inversion\". It causes a redstone torche attached to a piston to depower when that piston is powered.", false);
		public static final TickPrioritySetting TICK_PRIORITY_BURNOUT = new TickPrioritySetting("tickPriorityBurnout", "The tick priority of the tick scheduled when a redstone torch burns out.", TickPriority.NORMAL);
		public static final TickPrioritySetting TICK_PRIORITY_RISING_EDGE = new TickPrioritySetting("tickPriorityRisingEdge", Settings.Common.DESC_TICK_PRIORITY_RISING_EDGE, TickPriority.NORMAL);
		public static final TickPrioritySetting TICK_PRIORITY_FALLING_EDGE = new TickPrioritySetting("tickPriorityFallingEdge", Settings.Common.DESC_TICK_PRIORITY_FALLING_EDGE, TickPriority.NORMAL);
	}
	...
	public static class RedstoneWire {
		...
		private static final SettingsPack REDSTONE_WIRE = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final UpdateOrderSetting BLOCK_UPDATE_ORDER = new UpdateOrderSetting("blockUpdateOrder", "The order in which redstone wire updates its neighbors after a state change.", new UpdateOrder(Directionality.NONE, UpdateOrder.NotifierOrder.LOCATIONAL).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.SELF, RelativePos.WEST).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.DOWN, RelativePos.WEST).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.UP, RelativePos.WEST).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.NORTH, RelativePos.WEST).
				...
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.EAST, RelativePos.WEST));
		public static final IntegerSetting DELAY = new IntegerSetting("delay", Settings.Common.DESC_DELAY_ACTIVATING, 0, 0, Settings.Common.MAX_DELAY);
		public static final BooleanSetting INVERT_FLOW_ON_GLASS = new BooleanSetting("invertFlowOnGlass", "When enabled, redstone wire power can flow down glass, but not up it.", false);
		public static final BooleanSetting SLABS_ALLOW_UP_CONNECTION = new BooleanSetting("slabsAllowUpConnection", "When enabled, redstone wire can visually and logically connect to other redstone wire on top of a neighboring slab block.", true);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class Repeater {
		...
		private static final SettingsPack REPEATER = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final UpdateOrderSetting BLOCK_UPDATE_ORDER = new UpdateOrderSetting("blockUpdateOrder", "The order in which neighbors are updated when a repeater powers or depowers.", new UpdateOrder(Directionality.HORIZONTAL, UpdateOrder.NotifierOrder.NORMAL).
				add(BlockUpdate.Mode.SINGLE_UPDATE, RelativePos.SELF, RelativePos.FRONT).
				add(BlockUpdate.Mode.NEIGHBORS_EXCEPT, RelativePos.FRONT, RelativePos.BACK));
		public static final IntegerSetting DELAY_RISING_EDGE = new IntegerSetting("delayRisingEdge", Settings.Common.DESC_DELAY_RISING_EDGE, 2, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_FALLING_EDGE = new IntegerSetting("delayFallingEdge", Settings.Common.DESC_DELAY_FALLING_EDGE, 2, 0, Settings.Common.MAX_DELAY);
		public static final BooleanSetting LAZY_RISING_EDGE = new BooleanSetting("lazyRisingEdge", Settings.Common.DESC_LAZY_RISING_EDGE, true);
		public static final BooleanSetting LAZY_FALLING_EDGE = new BooleanSetting("lazyFallingEdge", Settings.Common.DESC_LAZY_FALLING_EDGE, false);
		public static final IntegerSetting POWER_WEAK = new IntegerSetting("weakPower", Settings.Common.DESC_POWER_WEAK, 15, 0, Settings.Common.MAX_POWER);
		public static final IntegerSetting POWER_STRONG = new IntegerSetting("strongPower", Settings.Common.DESC_POWER_STRONG, 15, 0, Settings.Common.MAX_POWER);
		public static final TickPrioritySetting TICK_PRIORITY_FACING_DIODE = new TickPrioritySetting("tickPriorityFacingDiode", Settings.Common.DESC_TICK_PRIORITY_FACING_DIODE, TickPriority.EXTREMELY_HIGH);
		public static final TickPrioritySetting TICK_PRIORITY_RISING_EDGE = new TickPrioritySetting("tickPriorityRisingEdge", Settings.Common.DESC_TICK_PRIORITY_RISING_EDGE, TickPriority.HIGH);
		public static final TickPrioritySetting TICK_PRIORITY_FALLING_EDGE = new TickPrioritySetting("tickPriorityFallingEdge", Settings.Common.DESC_TICK_PRIORITY_FALLING_EDGE, TickPriority.VERY_HIGH);
	}
	
	public static class Scaffolding {
		
		private static final String PACK_NAME = "Scaffolding";
		private static final SettingsPack SCAFFOLDING = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", "Delay in ticks before a scaffolding block updates its distance to the nearest supported scaffolding block.", 1, 0, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class SoulSand {
		...
		private static final SettingsPack SOUL_SAND = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", "Delay in ticks before a soulsand block updates water above it to create a bubble column.", 20, 0, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class Stairs {
		...
		private static final SettingsPack STAIRS = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final BooleanSetting FULL_FACES_ARE_SOLID = new BooleanSetting("fullFacesAreSolid", "When enabled, all full faces of stair blocks act like full solid blocks, meaning they conduct power and cut off redstone wire.", false);
	}
	
	public static class StickyPiston {
		
		private static final String PACK_NAME = "Sticky Piston";
		private static final SettingsPack STICKY_PISTON = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final BooleanSetting CONNECTS_TO_WIRE = new BooleanSetting("connectsToWire", "When enabled, sticky pistons connect to redstone wire.", false);
		public static final BooleanSetting DO_BLOCK_DROPPING = new BooleanSetting("doBlockDropping", "When enabled, sticky pistons drop their block when given a short pulse (less than or equal to their speed).", true);
		public static final BooleanSetting FAST_BLOCK_DROPPING = new BooleanSetting("fastBlockDropping", "When enabled and doBlockDropping is also enabled, a sticky piston will instantly place the block it is dropping.", true);
		public static final IntegerSetting DELAY_RISING_EDGE = new IntegerSetting("delayRisingEdge", Settings.Common.DESC_DELAY_RISING_EDGE, 0, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_FALLING_EDGE = new IntegerSetting("delayFallingEdge", Settings.Common.DESC_DELAY_FALLING_EDGE, 0, 0, Settings.Common.MAX_DELAY);
		public static final BooleanSetting IGNORE_UPDATES_WHILE_EXTENDING = new BooleanSetting("ignoreUpdatesWhileExtending", "Ignore any neighbor updates received during the extension.", false);
		public static final BooleanSetting IGNORE_UPDATES_WHILE_RETRACTING = new BooleanSetting("ignoreUpdatesWhileRetracting", "Ignore any neighbor updates received during the retraction.", true);
		public static final BooleanSetting LAZY_RISING_EDGE = new BooleanSetting("lazyRisingEdge", Settings.Common.DESC_LAZY_RISING_EDGE, false);
		public static final BooleanSetting LAZY_FALLING_EDGE = new BooleanSetting("lazyFallingEdge", Settings.Common.DESC_LAZY_FALLING_EDGE, false);
		public static final BooleanSetting MOVABLE_WHEN_EXTENDED = new BooleanSetting("movableWhenExtended", "Allow extended sticky pistons to be moved.", false);
		public static final IntegerSetting PUSH_LIMIT = new IntegerSetting("pushLimit", "The maximum number of blocks a piston can move.", 12, 0, 2048);
		public static final DirectionToBooleanSetting QC = new DirectionToBooleanSetting("quasiConnectivity", Settings.Common.DESC_QC, new Boolean[] {false, true, false, false, false, false});
		public static final BooleanSetting RANDOMIZE_QC = new BooleanSetting("randomizeQuasiConnectivity", Settings.Common.DESC_RANDOMIZE_QC, false);
		public static final IntegerSetting SPEED_RISING_EDGE = new IntegerSetting("speedRisingEdge", "The duration of the extension in ticks.", 2, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting SPEED_FALLING_EDGE = new IntegerSetting("speedFallingEdge", "The duration of the retraction in ticks.", 2, 0, Settings.Common.MAX_DELAY);
		public static final BooleanSetting SUPER_STICKY = new BooleanSetting("superSticky", "Make the face of sticky pistons stick to blocks when moved.", false);
		public static final BooleanSetting SUPPORTS_BRITTLE_BLOCKS = new BooleanSetting("supportsBrittleBlocks", "Allow brittle blocks, like torches, pressure plates and doors, to be placed on any face without breaking when the piston extends or retracts.", false);
		public static final BooleanSetting SUPPRESS_HEAD_UPDATES_ON_EXTENSION = new BooleanSetting("suppressHeadUpdatesOnExtension", "Suppress block updates emitted by the moving piston head when the piston starts extending.", false);
		public static final TickPrioritySetting TICK_PRIORITY_RISING_EDGE = new TickPrioritySetting("tickPriorityRisingEdge", Settings.Common.DESC_TICK_PRIORITY_RISING_EDGE, TickPriority.NORMAL);
		public static final TickPrioritySetting TICK_PRIORITY_FALLING_EDGE = new TickPrioritySetting("tickPriorityFallingEdge", Settings.Common.DESC_TICK_PRIORITY_FALLING_EDGE, TickPriority.NORMAL);
	...
	public static class StoneButton {
		...
		private static final SettingsPack STONE_BUTTON = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final UpdateOrderSetting BLOCK_UPDATE_ORDER = new UpdateOrderSetting("blockUpdateOrder", "The order in which neighboring blocks are updated when a button toggles.", new UpdateOrder(Directionality.ALL, UpdateOrder.NotifierOrder.NORMAL).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.SELF, RelativePos.WEST).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.FRONT, RelativePos.WEST));
		public static final IntegerSetting DELAY_RISING_EDGE = new IntegerSetting("delayRisingEdge", Settings.Common.DESC_DELAY_RISING_EDGE, 0, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_FALLING_EDGE = new IntegerSetting("delayFallingEdge", Settings.Common.DESC_DELAY_FALLING_EDGE, 20, 1, Settings.Common.MAX_DELAY);
		public static final IntegerSetting POWER_WEAK = new IntegerSetting("weakPower", Settings.Common.DESC_POWER_WEAK, 15, 0, Settings.Common.MAX_POWER);
		public static final IntegerSetting POWER_STRONG = new IntegerSetting("strongPower", Settings.Common.DESC_POWER_STRONG, 15, 0, Settings.Common.MAX_POWER);
		public static final TickPrioritySetting TICK_PRIORITY_RISING_EDGE = new TickPrioritySetting("tickPriorityRisingEdge", Settings.Common.DESC_TICK_PRIORITY_RISING_EDGE, TickPriority.NORMAL);
		public static final TickPrioritySetting TICK_PRIORITY_FALLING_EDGE = new TickPrioritySetting("tickPriorityFallingEdge", Settings.Common.DESC_TICK_PRIORITY_FALLING_EDGE, TickPriority.NORMAL);
	...
	public static class StonePressurePlate {
		...
		private static final SettingsPack STONE_PRESSURE_PLATE = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final UpdateOrderSetting BLOCK_UPDATE_ORDER = new UpdateOrderSetting("blockUpdateOrder", "The order in which neighboring blocks are updated when a pressure plate powers or depowers.", new UpdateOrder(Directionality.NONE, UpdateOrder.NotifierOrder.NORMAL).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.SELF, RelativePos.WEST).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.DOWN, RelativePos.WEST));
		public static final IntegerSetting DELAY_RISING_EDGE = new IntegerSetting("delayRisingEdge", Settings.Common.DESC_DELAY_RISING_EDGE, 0, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_FALLING_EDGE = new IntegerSetting("delayFallingEdge", Settings.Common.DESC_DELAY_FALLING_EDGE, 20, 1, Settings.Common.MAX_DELAY);
	...
	public static class SugarCane {
		...
		private static final SettingsPack SUGAR_CANE = new SettingsPack(PACK_NAME, new ArrayList<>());
	...
	public static class TargetBlock {
		...
		private static final SettingsPack TARGET_BLOCK = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY_DEFAULT = new IntegerSetting("delayDefault", "The default delay in ticks before powering off.", 8, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_PERSISTENT_PROJECTILE = new IntegerSetting("delayPersistentProjectile", "The delay in ticks before powering off when hit by a persistent projectile, like an arrow or a trident.", 20, 0, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class TNT {
		...
		private static final SettingsPack TNT = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", Settings.Common.DESC_DELAY_ACTIVATING, 0, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting FUSE_TIME = new IntegerSetting("fuseTime", "The delay in ticks before a TNT entity explodes.", 80, 0, Settings.Common.MAX_DELAY);
		public static final BooleanSetting LAZY = new BooleanSetting("lazy", Settings.Common.DESC_LAZY, false);
		public static final DirectionToBooleanSetting QC = new DirectionToBooleanSetting("quasiConnectivity", Settings.Common.DESC_QC, new Boolean[] {false, false, false, false, false, false});
		public static final BooleanSetting RANDOMIZE_QC = new BooleanSetting("randomizeQuasiConnectivity", Settings.Common.DESC_RANDOMIZE_QC, false);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	...
	public static class Tripwire {
		...
		private static final SettingsPack TRIPWIRE = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", "Delay in ticks before attempting to power off.", 10, 1, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class TripwireHook {
		...
		private static final SettingsPack TRIPWIRE_HOOK = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final UpdateOrderSetting BLOCK_UPDATE_ORDER = new UpdateOrderSetting("blockUpdateOrder", "The order in which neighboring blocks are updated when a tripwire hook powers on or off.", new UpdateOrder(Directionality.HORIZONTAL, UpdateOrder.NotifierOrder.NORMAL).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.SELF, RelativePos.WEST).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.FRONT, RelativePos.WEST));
		public static final IntegerSetting DELAY = new IntegerSetting("delay", "Delay in ticks before attempting to power off.", 10, 1, Settings.Common.MAX_DELAY);
		public static final IntegerSetting POWER_WEAK = new IntegerSetting("weakPower", Settings.Common.DESC_POWER_WEAK, 15, 0, Settings.Common.MAX_POWER);
	...
	public static class Vines {
		...
		private static final SettingsPack VINES = new SettingsPack(PACK_NAME, new ArrayList<>());
	...
	public static class Water {
		...
		private static final SettingsPack WATER = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final IntegerSetting DELAY = new IntegerSetting("delay", "Delay in ticks before attempting to flow.", 5, 0, Settings.Common.MAX_DELAY);
		public static final TickPrioritySetting TICK_PRIORITY = new TickPrioritySetting("tickPriority", Settings.Common.DESC_TICK_PRIORITY, TickPriority.NORMAL);
	}
	...
	public static class WoodenButton {
		...
		private static final SettingsPack WOODEN_BUTTON = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final UpdateOrderSetting BLOCK_UPDATE_ORDER = new UpdateOrderSetting("blockUpdateOrder", "The order in which neighboring blocks are updated when a button toggles..", new UpdateOrder(Directionality.ALL, UpdateOrder.NotifierOrder.NORMAL).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.SELF, RelativePos.WEST).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.FRONT, RelativePos.WEST));
		public static final IntegerSetting DELAY_RISING_EDGE = new IntegerSetting("delayRisingEdge", Settings.Common.DESC_DELAY_RISING_EDGE, 0, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_FALLING_EDGE = new IntegerSetting("delayFallingEdge", Settings.Common.DESC_DELAY_FALLING_EDGE, 30, 1, Settings.Common.MAX_DELAY);
		public static final IntegerSetting POWER_WEAK = new IntegerSetting("weakPower", Settings.Common.DESC_POWER_WEAK, 15, 0, Settings.Common.MAX_POWER);
		public static final IntegerSetting POWER_STRONG = new IntegerSetting("strongPower", Settings.Common.DESC_POWER_STRONG, 15, 0, Settings.Common.MAX_POWER);
		public static final TickPrioritySetting TICK_PRIORITY_RISING_EDGE = new TickPrioritySetting("tickPriorityRisingEdge", Settings.Common.DESC_TICK_PRIORITY_RISING_EDGE, TickPriority.NORMAL);
		public static final TickPrioritySetting TICK_PRIORITY_FALLING_EDGE = new TickPrioritySetting("tickPriorityFallingEdge", Settings.Common.DESC_TICK_PRIORITY_FALLING_EDGE, TickPriority.NORMAL);
	...
	public static class WoodenPressurePlate {
		...
		private static final SettingsPack WOODEN_PRESSURE_PLATE = new SettingsPack(PACK_NAME, new ArrayList<>());
		
		public static final UpdateOrderSetting BLOCK_UPDATE_ORDER = new UpdateOrderSetting("blockUpdateOrder", "The order in which neighboring blocks are updated when a pressure plate powers on or off.", new UpdateOrder(Directionality.NONE, UpdateOrder.NotifierOrder.NORMAL).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.SELF, RelativePos.WEST).
				add(BlockUpdate.Mode.NEIGHBORS, RelativePos.DOWN, RelativePos.WEST));
		public static final IntegerSetting DELAY_RISING_EDGE = new IntegerSetting("delayRisingEdge", Settings.Common.DESC_DELAY_RISING_EDGE, 0, 0, Settings.Common.MAX_DELAY);
		public static final IntegerSetting DELAY_FALLING_EDGE = new IntegerSetting("delayFallingEdge", Settings.Common.DESC_DELAY_FALLING_EDGE, 20, 1, Settings.Common.MAX_DELAY);
	...
	public static void init() {
		...
		Settings.register(TWEAKS, NormalPiston.NORMAL_PISTON, NormalPiston.SUPPRESS_HEAD_UPDATES_ON_EXTENSION);
		...
		Settings.register(TWEAKS, StickyPiston.STICKY_PISTON, StickyPiston.SUPPRESS_HEAD_UPDATES_ON_EXTENSION);
