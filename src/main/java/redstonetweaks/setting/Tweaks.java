...
public class Tweaks {
	...
	public static class Global {
		...
		public static final BooleanSetting DOUBLE_RETRACTION = new BooleanSetting(GLOBAL, "doubleRetraction", "A re-implementation of behavior that was present in 1.3-1.8, known as \"Jeb retraction\" or \"instant double retraction\". It creates a very narrow window where unpowered pistons can be moved.");
	...
	public static class StickyPiston {
		...
		public static final BooleanSetting SUPER_BLOCK_DROPPING = new BooleanSetting(STICKY_PISTON, "superBlockDropping", "When used in combination with doBlockDropping and fastBlockDropping, sticky pistons can drop not just the one block directly in front of them, but all the blocks they are pushing in front of that.");
