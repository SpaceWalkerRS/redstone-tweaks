...
public class Settings {
	...
	public static void registerSettings() {
		...
		pressurePlateDelay = register(new IntegerSetting("block_delay", "pressure_plate_delay", "pressure_plate", 20, 1, 127));
		pressurePlateOnDelay = register(new IntegerSetting("block_delay", "pressure_plate_on_delay", "pressure_plate_on", 0, 0, 127));
		...
		weightedPressurePlateDelay = register(new IntegerSetting("block_delay", "weighted_pressure_plate_delay", "weighted_pressure_plate", 10, 1, 127));
		weightedPressurePlateOnDelay = register(new IntegerSetting("block_delay", "weighted_pressure_plate_on_delay", "weighted_pressure_plate_on", 0, 0, 127));
