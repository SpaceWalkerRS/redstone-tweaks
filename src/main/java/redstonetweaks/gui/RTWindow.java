...
public abstract class RTWindow extends AbstractParentElement implements RTElement {
	...
	private void drawBackgroundTexture(MatrixStack matrices, int mouseX, int mouseY, float delta) {
